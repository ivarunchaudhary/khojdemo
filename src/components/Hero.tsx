  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        src="https://images.unsplash.com/photo-1568079776404-e0fc8c3fa7cb?auto=format&fit=crop&w=2200&q=80"
        alt="A young woman in a saree on an Indian street"
      ...
      <motion.div
        ...
        className="absolute top-1/2 -translate-y-1/2 right-4 sm:right-8 lg:right-12 z-10 hidden sm:block"
      >
        <div className="bg-cream/95 text-ink rounded-sm px-4 py-3 w-[160px] sm:w-[180px] shadow-2xl border border-ink/10">
          <div className="flex items-center justify-between font-mono text-[8px] uppercase tracking-[0.3em] text-ink/55">
            <span>FIELD STAMP</span>
            <span>№ 047</span>
          </div>
          <p className="mt-3 font-italic-display text-base leading-tight text-ink">
            Chamba,
            <br />
            Himachal Pradesh
          </p>
          <p className="mt-3 pt-2 border-t border-ink/10 font-mono text-[8px] text-ink/50 tracking-wider">
            32.55°N &nbsp;·&nbsp; 76.12°E
          </p>
        </div>
      </motion.div>
      ...
      <div className="relative h-full mx-auto max-w-7xl px-6 lg:px-10 flex items-center pt-28">
        <div className="max-w-2xl">
          ...
          >
            <a
              href="#archive"
              className="rounded-full bg-cream text-ink px-5 py-2.5 font-mono text-[10px] uppercase tracking-[0.25em] hover:bg-bone transition-all hover:-translate-y-0.5 flex items-center gap-2"
            >
              EXPLORE THE ARCHIVE <span>→</span>
            </a>
            <a
              href="#archive"
              className="rounded-full border border-cream/35 text-cream px-5 py-2.5 font-mono text-[10px] uppercase tracking-[0.25em] hover:bg-cream/10 hover:border-cream/60 transition-all hover:-translate-y-0.5"
            >
              SHOP DISCOVERIES
            </a>
          </motion.div>
