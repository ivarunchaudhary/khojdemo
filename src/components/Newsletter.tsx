...
export function Newsletter() {
  ...
  return (
    <section id="join" className="bg-wine relative grain">
      <div className="relative z-10 mx-auto max-w-3xl px-6 lg:px-10 py-16 sm:py-20 lg:py-24 text-center">
        <Reveal>
          <p className="font-mono text-[10px] uppercase tracking-[0.4em] text-cream/70">
            POSTAGE · KHOJ × YOU
          </p>
          <p className="mt-2 font-mono text-[10px] uppercase tracking-[0.4em] text-cream/55">
            NOTES FROM THE ROAD
          </p>
          ...
          <p className="mt-6 text-cream/85 font-serif text-base sm:text-lg max-w-xl mx-auto">
        ...
        <Reveal delay={0.15}>
          ...
          >
            <label
              htmlFor="email"
              className="block font-mono text-[10px] uppercase tracking-[0.3em] text-cream/70 mb-2"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 bg-ink/40 border border-cream/15 rounded-full px-5 py-3 text-cream placeholder:text-cream/55 focus:outline-none focus:border-cream/40 transition-colors"
              />
              <motion.button
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.98 }}
          ...
          <p className="mt-6 font-mono text-[10px] uppercase tracking-[0.3em] text-cream/55 text-center">
